...
void TitleScene::Initialize() {
	...
	backGround_.reset(Sprite::Create(TextureManager::Load("title_BG.png"), backGround_Pos_));
	backGround_->SetSize({1280.0f, 720.0f});

	titleText_ = std::make_unique<Sprite>();
	titleText_.reset(Sprite::Create(TextureManager::Load("title.png"), title_Pos_));
